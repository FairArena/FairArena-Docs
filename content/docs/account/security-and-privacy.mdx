...
<Callout type="warning">
  Keep your backup codes in a safe place! You'll need them if you lose access to
  your 2FA device.
</Callout>
...
<Callout type="info">
  Regularly review your account logs to ensure all activity is authorized.
...
<Callout type="info">
  Disabling essential cookies may affect platform functionality. Analytics and
  preference cookies can be safely disabled.
</Callout>
...
- Security: support@fairarena.app
- Privacy: legal@fairarena.app
- General: contact@fairarena.app
