      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
            Everything you need to master FairArena - the modern collaboration
      ...
      <section className="py-20 px-4 bg-white dark:bg-gray-950">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Link
              href="/docs/guides"
              className="group p-6 rounded-2xl border-2 border-gray-200 dark:border-gray-800 hover:border-blue-500 dark:hover:border-blue-500 hover:shadow-lg transition-all duration-200"
            >
            ...
            <Link
              href="/docs/features"
              className="group p-6 rounded-2xl border-2 border-gray-200 dark:border-gray-800 hover:border-purple-500 dark:hover:border-purple-500 hover:shadow-lg transition-all duration-200"
            >
              ...
              <p className="text-muted-foreground text-sm">
                Deep dive into powerful platform capabilities
              </p>
            </Link>

            <Link
              href="/docs/account"
              className="group p-6 rounded-2xl border-2 border-gray-200 dark:border-gray-800 hover:border-green-500 dark:hover:border-green-500 hover:shadow-lg transition-all duration-200"
            >
              ...
              <p className="text-muted-foreground text-sm">
                Manage settings and protect your data
              </p>
            </Link>

            <Link
              href="/docs/credits-and-pricing"
              className="group p-6 rounded-2xl border-2 border-gray-200 dark:border-gray-800 hover:border-yellow-500 dark:hover:border-yellow-500 hover:shadow-lg transition-all duration-200"
            >
              ...
              <p className="text-muted-foreground text-sm">
                Understand credits and billing options
              </p>
            </Link>
            ...
            <a
              ...
              className="group p-6 rounded-2xl border-2 border-gray-200 dark:border-gray-800 hover:border-pink-500 dark:hover:border-pink-500 hover:shadow-lg transition-all duration-200"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group p-6 rounded-2xl border-2 border-gray-200 dark:border-gray-800 hover:border-gray-500 dark:hover:border-gray-500 hover:shadow-lg transition-all duration-200"
            >
              <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-gray-700 to-gray-900 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                <svg className="w-6 h-6 text-white" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                  <path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.387.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.612-4.042-1.612-.546-1.387-1.333-1.757-1.333-1.757-1.089-.744.083-.729.083-.729 1.205.084 1.84 1.236 1.84 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.42-1.305.763-1.605-2.665-.3-5.467-1.335-5.467-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297 24 5.67 18.627.297 12 .297z"/>
                </svg>
              </div>
              ...
              <p className="text-muted-foreground text-sm">
                View docs source and contribute
              </p>
            </a>
          </div>
        </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <p className="text-xl mb-8 opacity-90">
            Join thousands of professionals collaborating on FairArena
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            <Link
